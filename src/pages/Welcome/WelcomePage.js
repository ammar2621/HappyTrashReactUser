                      ...
                      <MDBModalBody>
                        <ol className="text-justify">
                          <li>
                            ...
                            information regarding the type and specifications of
                            the goods to be delivered.
                          </li>
                          <li>
                            Happy Trash does not provide specific box for
                            shipping. Customers are responsible for properly
                            packing the goods to be delivered. For fragile items
                            made of glass, ceramic and includes cakes, ice
                            cream, food and fresh flowers, it is suggested that
                            the item is specially packaged. Happy Trash is not
                            responsible for damage or deformation that occurs
                            upon delivery of such goods.
                          </li>
                        </ol>
                      </MDBModalBody>
                      <MDBModalFooter>
